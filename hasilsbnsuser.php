			...
			<div class="section-card" style="padding: 20px 0px">
				...
				<ul>
												...
												<tbody>
													<tr>
														...
														for ($i=0; $i < count($nilaiV); $i++) { 
															if ($nilaiV[$i] == $testmax) {
																$query=mysqli_query($selectdb,"SELECT * FROM tb_sensitif where id_sbns = $i+1");
																?>
					...
					<div class="row center" \>
						<a href="rekomendasi_sbnsuser.php" id="download-button" class="waves-effect waves-light btn" style="margin-top: 0px">Hitung Rekomendasi Ulang</a>
					</div>
				</div>
			</div>
		</div>
