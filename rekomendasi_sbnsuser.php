            ...
            <ul class="right hide-on-med-and-down">
                ...
                <li>
                    ...
                    <ul id="dropdown1" class="dropdown-content">
                        <li><a   href="rekomendasi_sbnbuser.php">Kulit Berminyak</a></li>
                        <li><a class="active" href="rekomendasi_sbnsuser.php">Kulit Sensitif</a></li>
                    </ul>
                </li>
                        ...
                        <div class="row">
                            <div class="col s12">
                                <div class="row">
                                    ...
                                    <br>
                                    <form class="col s12" method="POST" action="hasilsbnsuser.php">
                                        <div class="row">
                                            <div class="col s12">
