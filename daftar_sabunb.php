...
if (isset($_POST["tambah_sabun"])) {
	...
	$sql = "INSERT INTO `tb_berminyak` (`id_sbnb`, `merek_sabun`, `merek`, `kesesuaian_kulit`, `harga_sabun`, `kualitas_sabun`, `rata_umur_pengguna`, `merek_angka`, `kesesuaian_angka`, `harga_angka`, `kualitas_angka`, `umur_angka`) 
...
if (isset($_POST["hapus_sabun"])) {
	...
	$sql_delete = "DELETE FROM `tb_berminyak` WHERE `id_sbnb` = :id_hapus_sabun";
	$stmt_delete = $db->prepare($sql_delete);
	$stmt_delete->bindValue(':id_hapus_sabun', $id_hapus_sabun);
	$stmt_delete->execute();
	$query_reorder_id = mysqli_query($selectdb, "ALTER TABLE tb_berminyak AUTO_INCREMENT = 1");
}
?>
						...
						<div class="row">
							<div class="card">
								<div class="card-content">
									<center>
										<h4 style="margin-bottom: 0px; margin-top: -8px;">Daftar Sabun Wajah Kulit Berminyak</h4>
									</center>
											...
											?>
												<tr>
													...
													<td>
														<center>
															<form method="POST">
																<input type="hidden" name="id_hapus_sabun" value="<?php echo $data['id_sbnb'] ?>">
